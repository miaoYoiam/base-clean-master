...
public class MineDeviceHelper {
    private final static String TAG = "MineDeviceHelper";
    ...
    static {
        ...
        try {
            ...
            Log.e(TAG, e.toString() + " read SystemProperties error");
        }
    }
