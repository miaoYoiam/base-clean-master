...
public class StatusBarHelper {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(MineDeviceHelper.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (MineNotchHelper.isNotchOfficialSupport()) {
            handleDisplayCutoutMode(window);
        }

        // 小米和魅族4.4 以上版本支持沉浸式
        // 小米 Android 6.0 ，开发版 7.7.13 及以后版本设置黑色字体又需要 clear FLAG_TRANSLUCENT_STATUS, 因此还原为官方模式
        if (MineDeviceHelper.isMeizu() || (MineDeviceHelper.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//                decorView.getRootWindowInsets().getds() != null) {
...
//        }
    ...
    public static boolean setStatusBarLightMode(Activity activity) {
        ...
        if (MineDeviceHelper.isZTKC2016()) {
            return false;
        }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (MineDeviceHelper.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return MineDeviceHelper.isMIUIV5() || MineDeviceHelper.isMIUIV6() ||
                MineDeviceHelper.isMIUIV7() || MineDeviceHelper.isMIUIV8();
    }
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(MineDeviceHelper.isZUKZ1() || MineDeviceHelper.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (MineDeviceHelper.isTablet(context)
                && sStatusbarHeight > MineDisplayHelper.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
